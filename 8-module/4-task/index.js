...
export default class Cart {
  ...
  renderModal() {
    ...
    let cartProducts = this.modal._modal.querySelectorAll('.cart-product');
    ...
    this.cartForm = this.modal._modal.querySelector('.cart-form');
  ...
  onProductUpdate(cartItem) {
    if (document.body.classList.contains('is-modal-open')) {
      let modalBody = this.modal._modal;
  ...
  async onSubmit(event) {
    ...
    this.modal._modal.querySelector('[type="submit"]').classList.add('is-loading');
